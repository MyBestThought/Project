package com.yht.example.minegame.view;
...
import com.yht.example.minegame.Mine;
import com.yht.example.minegame.aidl.MineDataProvider;
import com.yht.example.minegame.MineManager;
import com.yht.example.minegame.R;

/**
 * Created by Administrator on 2019/12/26 0026.
 */

public class MineView extends AppCompatButton implements View.OnClickListener, View.OnLongClickListener{
        ...
        if(mine != null){
            ...
            if(isclick && mMine.type == Mine.TYPE_MINE){
                ...
                if (MineDataProvider.clickMines != null)
                    MineDataProvider.clickMines.add(com.yht.example.minegame.aidl.Mine.toJson(mine.x, mine.y, mineNum));
            }else {
