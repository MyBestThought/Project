...
<script type="text/javascript">
	$(function(){
		...
		$("#vcodeImg").click(function(){
			// this.src="/system/getCheckCode";
			this.src="/system/getCheckCode?vl=4&w=98&h=33&t="+new Date().getTime();
		});
    ...
    <form id="form" class="form form-horizontal" method="post">
      ...
      <div class="row cl">
        <div class="formControls col-8 col-offset-3">
          ...
          <img title="点击图片切换验证码" id="vcodeImg" src="/system/getCheckCode">
        </div>
      </div>
...
<div class="footer">Copyright &nbsp; YHT @ Lizhou </div>
