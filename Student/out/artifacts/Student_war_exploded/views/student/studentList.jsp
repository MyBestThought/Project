    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            $('#dataList').datagrid({
                ...
                fit: true,//自动大小
                method: "post",
                url:"/student/getList?t="+new Date().getTime(),
                idField:'id',
...
<div id="addDialog" style="padding: 10px;">
    <form id="photoForm" method="post" enctype="multipart/form-data" action="/student/upload_photo" target="photo_target">
        <table id="addTable1" cellpadding="8">
            <tr >
                <td>预览头像:</td>
                <td>
                    <img id="photo-preview" alt="照片" style="max-width: 100px; max-height: 100px;" title="照片" src="/photo/student.png" />
                </td>
            </tr>
            <tr >
                <td>学生头像:</td>
...
<div id="editDialog" style="padding: 10px">
    <form id="editPhotoForm" method="post" enctype="multipart/form-data" action="/student/upload_photo" target="photo_target">
